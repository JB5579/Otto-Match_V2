...
# Import actual PreferenceCategory enum instead of aliasing to Any
from src.intelligence.preference_engine import PreferenceCategory

# Configure logging
logger = logging.getLogger(__name__)

# Type hints to avoid circular imports (postponed evaluation via annotations)
GroqClient = Any
PreferenceEngine = Any
# Note: PreferenceCategory imported from preference_engine to avoid shadowing the enum
UserPreference = Any
